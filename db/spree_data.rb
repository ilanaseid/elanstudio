...
spree_admin_user=Spree::User.new(:firstname=>'Systems', :lastname=>'User', :email=>'ilana@elanstudio.com', :password=>'beatrice')
spree_admin_user.spree_roles << Spree::Role.find_by_name('admin')
spree_admin_user.save

#Setup default cms admin user
cms_admin_user=ClearCMS::User.create(:email=>'ilana@elanstudio.com', :base_name=>'systems', :full_name=>'Systems', :short_name=>'systems', :password=>'beatrice', :system_permission=>'administrator')

#Setup default cms site
default_site=ClearCMS::Site.create(:domain=>'elanstudio.com', :slug=>'elanstudio', :name=>'Elan Studio', :default=>true)
