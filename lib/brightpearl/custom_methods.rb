  ...
  module CustomMethods
    ...
    module ClassMethods
      def custom_method_collection_url(method_name, options = {})
        ...
        "#{api_prefix}#{prefix(prefix_options)}#{service_name}-service/#{collection_name.dasherize}/#{method_name}#{format_extension}#{query_string(query_options)}"
      end
    end
    ...
    private
      def custom_method_element_url(method_name, options = {})
        "#{self.class.api_prefix}#{self.class.prefix(prefix_options)}#{self.class.service_name}-service/#{self.class.collection_name.dasherize}/#{id}/#{method_name}#{self.class.format_extension}#{self.class.__send__(:query_string, options)}"
      end

      def custom_method_new_element_url(method_name, options = {})
        "#{self.class.api_prefix}#{self.class.prefix(prefix_options)}#{self.class.service_name}-service/#{self.class.collection_name.dasherize}/new/#{method_name}#{self.class.format_extension}#{self.class.__send__(:query_string, options)}"
      end
  end
end
